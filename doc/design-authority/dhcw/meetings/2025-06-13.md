...
| --------- | ---- | ------- |
| TDA-001   | [ADR Process](../architecture-decision-record-process.md) for Approval | Approved & Action TDA-A003 |
...
| TDA-003   | [Digital Products & Software Engineering Principles](../../../principles/dhcw/digital-products-and-software-engineering.md) for Approval | To return for approval next TDA |
| TDA-004   | [Enterprise Architecture Metamodel](../ea-metamodel/index.md) for Information | N/A |
| TDA-005   | [UCD Principles](../../../principles/dhcw/user-centred-design.md) for Approval | To return for approval next TDA |
